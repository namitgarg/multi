    ...
    <div class="addr-container">
        <div class="wrapper-buss-main">
            ...
            <?php if (!empty($content['field_address'])): ?>           
                <div class="wrapper-addr-1"><?php print render($content['field_address']); ?></div>
            <?php endif; ?>
            ...
            <?php        
               ...
               if (!empty($content['field_phone'])): ?> 
                ...
                <div class="wrapper-phone"><a href="tel:<?php print $phone; ?>"><?php print render($content['field_phone']); ?></a></div>
            <?php endif; ?>
